...
Services.factory('SearchAlbumsResource',
  function ($resource) {
      return $resource("/api/picasa/get-albums", {}, {
          Get: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumResource',
  function ($resource) {
      return $resource("/api/picasa/get-album", {}, {
          Get: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumsResource',
  function ($resource) {
      return $resource('/api/picasa/get-album-type', {}, {
          GetAlbums: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumTypesResource',
  function ($resource) {
      return $resource('/api/picasa/get-album-types', {}, {
          GetAlbumTypes: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumIdResource',
  function ($resource) {
      return $resource('/api/picasa/get-album-id', {}, {
          GetAlbumId: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumsYearResource',
  function ($resource) {
      return $resource('/api/picasa/get-albums-year', {}, {
          GetAlbums: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumsMonthResource',
  function ($resource) {
      return $resource('/api/picasa/get-albums-month', {}, {
          GetAlbums: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumsDayResource',
  function ($resource) {
      return $resource('/api/picasa/get-albums-day', {}, {
          GetAlbums: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumCountResource',
  function ($resource) {
      return $resource('/api/picasa/get-album-count', {}, {
          GetAlbumCount: {
              method: 'GET'
          }
      });
...
Services.factory('ImportAlbumResource',
  function ($resource) {
      return $resource('/api/picasa/import-albums', {}, {
          ImportAlbums: {
              method: 'GET'
          }
      });
...
Services.factory('ImportPhotoResource',
  function ($resource) {
      return $resource('/api/picasa/import-photos', {}, {
          ImportPhotos: {
              method: 'GET'
          }
      });
...
Services.factory('ImportAlbumsAllResource',
  function ($resource) {
      return $resource('/api/picasa/import-albums-all', {}, {
          ImportAlbums: {
              method: 'GET'
          }
      });
...
Services.factory('ImportAlbumJobResource',
  function ($resource) {
      return $resource('/api/picasa/import-albums-job', {}, {
          ImportAlbums: {
              method: 'GET'
          }
      });
...
Services.factory('ImportPhotoJobResource',
  function ($resource) {
      return $resource('/api/picasa/import-photos-job', {}, {
          ImportPhotos: {
              method: 'GET'
          }
      });
...
Services.factory('SplitAutoBackupResource',
  function ($resource) {
      return $resource('/api/picasa/split-auto-backup', {}, {
          SplitAlbum: {
              method: 'GET'
          }
      });
...
Services.factory('DupAlbumsResource',
  function ($resource) {
      return $resource('/api/picasa/get-dup-albums', {}, {
          GetDupAlbums: {
              method: 'GET'
          }
      });
...
Services.factory('MergeDupAlbumResource',
  function ($resource) {
      return $resource('/api/picasa/merge-dup-albums', {}, {
          MergeDupAlbums: {
              method: 'PATCH'
          }
      });
...
Services.factory('MergeAlbumsResource',
  function ($resource) {
      return $resource('/api/picasa/merge-albums', {}, {
          Merge: {
              method: 'PATCH'
          }
      });
...
Services.factory('TagsResource',
  function ($resource) {
      return $resource('/api/picasa/get-tags?startIndex=1&maxResults=100', {}, {
          GetTags: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumPhotoListResource',
  function ($resource) {
      return $resource('/api/picasa/get-album-photo-list', {}, {
          GetAlbumPhotos: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumPhotoCountResource',
  function ($resource) {
      return $resource('/api/picasa/get-album-photo-count', {}, {
          GetAlbumPhotoCount: {
              method: 'GET'
          }
      });
...
Services.factory('PhotoResource',
  function ($resource) {
      return $resource('/api/picasa/get-photo', {}, {
          Get: {
              method: 'GET'
          }
      });
...
Services.factory('PhotosResource',
  function ($resource) {
      return $resource('/api/picasa/get-photos', {}, {
          Get: {
              method: 'GET'
          }
      });
...
Services.factory('AlbumPhotosResource',
  function ($resource) {
      return $resource('/api/picasa/get-album-photos', {}, {
          Get: {
              method: 'GET'
          }
      });
...
Services.factory('UpdatePhotoResource',
  function ($resource) {
      return $resource('/api/picasa/update-photo', {}, {
          Save: {
              method: 'PATCH'
          }
      });
...
Services.factory('UpdatePhotoPartialResource',
  function ($resource) {
      return $resource('/api/picasa/update-photo-partial', {}, {
          Update: {
              method: 'PATCH'
          }
      });
...
Services.factory('DeletePhotosResource',
  function ($resource) {
      return $resource('/api/picasa/delete-photos', {}, {
          Delete: {
              method: 'DELETE'
          }
      });
...
Services.factory('DeletePhotoResource',
  function ($resource) {
      return $resource('/api/picasa/delete-photo', {}, {
          Delete: {
              method: 'DELETE'
          }
      });
...
Services.factory('CreateAlbumResource',
  function ($resource) {
      return $resource('/api/picasa/create-album', {}, {
          Save: {
              method: 'POST'
          }
      });
...
Services.factory('UpdateAlbumResource',
  function ($resource) {
      return $resource('/api/picasa/update-album', {}, {
          Save: {
              method: 'PATCH'
          }
      });
...
Services.factory('DeleteAlbumsResource',
  function ($resource) {
      return $resource('/api/picasa/delete-albums', {}, {
          Delete: {
              method: 'DELETE'
          }
      });
...
Services.factory('DeleteAlbumResource',
  function ($resource) {
      return $resource('/api/picasa/delete-album', {}, {
          Delete: {
              method: 'DELETE'
          }
      });
...
Services.factory('DeleteAlbumConfirmResource',
  function ($resource) {
      return $resource('/api/picasa/delete-album-confirm', {}, {
          Delete: {
              method: 'DELETE'
          }
      });
...
Services.factory('GetSearchResource',
  function ($resource) {
      return $resource("/api/youtube/get-search", {}, {
          Get: {
              method: 'GET',
              isArray: true
          }
...
Services.factory('GetSearchAllResource',
  function ($resource) {
      return $resource("/api/youtube/get-search-all", {}, {
          Get: {
              method: 'GET'
          }
      });
...
Services.factory('InsertSearchResource',
  function ($resource) {
      return $resource("/api/youtube/insert-search", {}, {
          Insert: {
              method: 'GET'
          }
      });
...
Services.factory('DeleteSearchResource',
  function ($resource) {
      return $resource("/api/youtube/delete-search", {}, {
          Delete: {
              method: 'DELETE'
          }
      });
