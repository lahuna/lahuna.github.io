...
var ctl = angular.module('ViewerPhotosController', ['ResourceFactory', 'AuthenticateFactory']);

ctl.controller('ViewerPhotosCtrl', function ($scope, $routeParams,
  $modal, $log, PicasaResource, PicasaPhotoResource, Auth) {
