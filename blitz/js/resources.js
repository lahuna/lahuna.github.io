...
fac.factory('GoogleRefreshTokenResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/google/refresh_token', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('ImgurRefreshTokenResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/imgur/refresh_token', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('RedditAccessTokenResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/reddit/access_token', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('RedditRefreshTokenResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/reddit/refresh_token', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('RedditProfileResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/reddit/profile', {}, {
    Get: {
      method: 'GET'
    }
  });
...
fac.factory('RedditPostResource', function ($resource) {
  return function (accessToken) {
    return $resource('https://' + location.hostname + ':3001/reddit/post', {}, {
      Post: {
        method: 'POST',
        params: {
...
fac.factory('LinkedInAccessTokenResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/linkedin/access_token', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('LinkedInProfileResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/linkedin/profile', {}, {
    Get: {
      method: 'GET'
    }
  });
...
fac.factory('LinkedInPostResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/linkedin/post', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('TwitterRequestTokenResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/twitter/request_token', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('TwitterAccessTokenResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/twitter/access_token', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('TwitterProfileResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/twitter/profile', {}, {
    Get: {
      method: 'GET'
    }
  });
...
fac.factory('TwitterPostResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/twitter/post', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('TumblrRequestTokenResource', function ($resource) {
    return $resource('https://' + location.hostname + ':3001/tumblr/request_token', {}, {
      Post: {
        method: 'POST'
      }
    });
...
fac.factory('TumblrAccessTokenResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/tumblr/access_token', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('TumblrProfileResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/tumblr/profile', {}, {
    Get: {
      method: 'GET'
    }
  });
...
fac.factory('TumblrPostResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/tumblr/post', {}, {
    Post: {
      method: 'POST'
    }
  });
