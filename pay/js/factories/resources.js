...
fac.factory('BraintreeClientTokenResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/braintree/client_token', {}, {
    Get: {
      method: 'GET'
    }
  });
...
fac.factory('BraintreeCheckoutResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/braintree/checkout', {}, {
    Post: {
      method: 'POST'
    }
  });
...
fac.factory('BraintreeOnboardResource', function ($resource) {
  return $resource('https://' + location.hostname + ':3001/braintree/onboard', {}, {
    Post: {
      method: 'POST'
    }
  });
