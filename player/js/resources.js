...
// Youtube Search
fac.factory('YoutubeSearchResource',
  function ($resource) {
...
// Video
fac.factory('VideoResource', ['$resource',
  function ($resource) {
      return function (accessToken) {
...
// Playlist Items
fac.factory('PlaylistItemResource',
  function ($resource) {
      return function (accessToken) {
